...
\begin{align*}
 \hE-\hbp\cdot\bsig&=\ii\partial-q\Phi^*,
 \\
 \hE+\hbp\cdot\bsig&=\ii\partial^*-q\Phi.
\end{align*}
...
the Dirac operator as a function of the mass argument:
\begin{align}
 \hD(m)&:=\Wop(\ii\partial)-m\bI,
...
\begin{equation}
 \hD(-m)\hD(m)=\Wop(\ii\partial)^2-m^2\bI
            =-(\Box+m^2)\bI.
...
Since $\hD(m)+m\bI=\Wop(\ii\partial)$, \eqref{eq:dirac-free-factorization} gives
\[
...
Dirac operator and its opposite-mass partner
\begin{align}
 \hD(m)&:=\Wop(\ii\partial-q\Phi^*)-m\bI,
...
\end{equation*}
With $\hE'=\ii\partial_t-qV'$ and $\hbp'=-\ii\pdr-q\bA'$, the same
product rule gives
\begin{align*}
...
\begin{align*}
 ...
 \Psi_2'(X')&=T\Psi_2(X).
\end{align*}
Indeed, the first interacting equation~\eqref{eq:dirac-entry-one}
transforms by cancellation:
\begin{equation*}
 (\ii\partial'-q\Phi'^*)\Psi_2'
 =T^*(\ii\partial-q\Phi^*)\Psi_2=m\Psi_1'.
\end{equation*}
...
For the free field, the Dirac operator, equation, and factorization are
\begin{align*}
 \hD(m)&=\Wop(\ii\partial)-m\bI,
...
\begin{align*}
 ...
 \hD(m)\bPsi&=(\Wop(\ii\partial-q\Phi^*)-m\bI)\bPsi=0.
