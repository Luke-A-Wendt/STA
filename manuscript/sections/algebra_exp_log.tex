...
\[
\pv{X}=a+\vct{A}\cdot\sigv\in\Pspace(\R),
\]
...
\(\lambda(\pv{Y},\pm)=\exp(a\pm\theta)\). The relation is expanded as
\begin{align*}
\pv{Y}
&=\exp(\pv{X})\notag \\
...
\begin{align*}
\pv{X} &= a + \vct{A} \cdot \sigv \in \Pspace(\R),\notag \\
\pv{Y} &= b + \vct{B} \cdot \sigv \in \Pspace(\R),\notag \\
