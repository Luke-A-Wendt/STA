...
Writing out \(D\bPsi=0\) gives the two coupled equations
\begin{align*}
...
\begin{align*}
0=D'D\bPsi
&=\bigl(W(i\partial-q\Phi^*)^2-m^2\I\bigr)\bPsi\notag\\
&=-\operatorname{diag}\!\Big(
...
Therefore,
\begin{align*}
0&=(W(i\partial-q\Phi^*)-m\I)\bPsi\notag\\
&=(W(i\partial-q\Phi^*)-m\I)e^{iq\lambda}\bPsi'\notag\\
&=e^{iq\lambda}(W(i\partial-q\,\partial\lambda-q\Phi^*)-m\I)\bPsi'\notag\\
&=e^{iq\lambda}(W(i\partial-q(\Phi'-\Phi)^*-q\Phi^*)-m\I)\bPsi'\notag\\
&=e^{iq\lambda}(W(i\partial-q\Phi'^*)-m\I)\bPsi'.
\end{align*}
Hence
\begin{equation*}
(W(i\partial-q\Phi'^*)-m\I)\bPsi'=0.
\end{equation*}
...
\begin{equation*}
\bigl(W(i\partial-q\Phi^*)-m\I\bigr)\bPsi'=0.
\end{equation*}
