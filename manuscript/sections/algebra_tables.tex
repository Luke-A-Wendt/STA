\noindent Table~\ref{tab:sigma-grade-components-app} records the sigma grades \(0\) through \(3\) together with the representative basis elements attached to each sector.
\begin{center}
...
\small
\begin{tabular}{@{}c l L{0.58\textwidth}@{}}
\toprule
