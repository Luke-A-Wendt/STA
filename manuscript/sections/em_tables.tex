...
\noindent Tables~\ref{tab:components-fsquare} and \ref{tab:components-ffrev} summarize the electromagnetic invariants and the energy-density/Poynting split built from \(\mathbf F\cdot\sigv\).
\begin{componenttable}[tab:components-fsquare]{\tfrac12(\mathbf F\cdot\sigv)^{2}}
...
\begin{componenttable}[tab:components-ffrev]{\tfrac12(\mathbf F\cdot\sigv)(\mathbf F\cdot\sigv)^{\mathrm R}}
...
\begin{componenttable}[tab:components-maxwell]{\partial(\mathbf F\cdot\sigv)=\rho-\mathbf J\cdot\sigv}
...
\begin{componenttable}[tab:components-wave-f]{\square(\mathbf F\cdot\sigv)=\partial^{*}(\rho-\mathbf J\cdot\sigv)}
...
\noindent Table~\ref{tab:components-potential-gradient} records the component content of the potential identity \(\partial\Phi=S+(\mathbf F\cdot\sigv)^{*}\).
\begin{componenttable}[tab:components-potential-gradient]{\partial\Phi=S+(\mathbf F\cdot\sigv)^{*}}
...
\noindent Table~\ref{tab:components-fu} is the component form of the product \((\mathbf F\cdot\sigv)U/\gamma\) used in the Lorentz-force law.
\begin{componenttable}[tab:components-fu]{(\mathbf F\cdot\sigv)U/\gamma}
...
\begin{componenttable}[tab:components-partial-fsquare]{\partial(\mathbf F\cdot\sigv)^{2}}
...
\begin{componenttable}[tab:components-fdstar]{(\mathbf F\cdot\sigv) D^{*}}
...
\begin{componenttable}[tab:components-dstarf]{D^{*}(\mathbf F\cdot\sigv)}
\componentrow{real scalar}{-\mathbf E\cdot\mathbf J}{}
\componentrow{imaginary scalar}{-\mathbf B\cdot\mathbf J}{}
\componentrow{real vector}{\rho\mathbf E-\mathbf B\times\mathbf J}{}
\componentrow{imaginary vector}{\rho\mathbf B+\mathbf E\times\mathbf J}{}
...
\begin{componenttable}[tab:components-dstarf-plus-fdstar]{D^{*}(\mathbf F\cdot\sigv)+(\mathbf F\cdot\sigv) D^{*}}
