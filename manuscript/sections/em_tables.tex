...
\begin{componenttable}[tab:components-fsquare]{\tfrac12 F^{2}}
...
\begin{componenttable}[tab:components-ffrev]{\tfrac12 F F^{\mathrm R}}
...
\noindent Table~\ref{tab:components-fu} is the component form of the product \(FU/\gamma\) used in the Lorentz-force law.
